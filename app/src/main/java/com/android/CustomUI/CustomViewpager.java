 ...
 * This Viewpager has most features and elements as original Viewpager
 * except this custom viewpager doesn't change state when scrolling -- need to change state by tabs
 */
